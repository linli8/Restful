...
namespace Restful.Data.Oracle.Linq
{
    public class OracleUpdateable<T> : IUpdateable<T>
    {
        ...
        public OracleUpdateable( IUpdateProvider provider )
        {
        ...
        public OracleUpdateable( IUpdateProvider provider, Type elementType )
        {
            this.provider = provider;
        ...
        //        private readonly OracleUpdatePartsAggregator updatePartsAggregator;
        //
        //        /// <summary>
        //        /// 构造方法
        //        /// </summary>
        //        /// <param name="provider"></param>
        //        public OracleUpdateable( ISessionProvider provider ) : base( provider )
        //        {
