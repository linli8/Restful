...
namespace Restful.Data.MySql.Visitors
{
    ...
    {
        protected MySqlWherePartsCommandBuilder commandBuilder;
        ...
        /// 构造函数
        /// </summary>
        public MySqlWhereClauseVisitor()
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public void Translate( Expression expression, MySqlWherePartsCommandBuilder commandBuilder )
        {
