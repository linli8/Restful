...
{
    public class SessionProviderFactories
    {
        #region Member
        ...
        /// 存储已注册的 Session 工厂
        /// </summary>
        private static IDictionary<string, ISessionProviderFactory> factories = new Dictionary<string, ISessionProviderFactory>();
        ...
        public static void Register<T>() where T : ISessionProviderFactory
        {
        ...
        /// <returns></returns>
        public static ISessionProviderFactory GetFactory( string providerName )
        {
