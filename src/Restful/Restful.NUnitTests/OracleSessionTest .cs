    ...
    public class OracleSessionTest
    {
        ...
        public void ExecuteDataPage()
        {
            using( ISession session = SessionFactory.CreateDefaultSession() )
            {
                ...
                string sql = "select * from Person where CreateTime < ?";

                var dataPage = session.ExecuteDataPage( sql, 1, 20, "CreateTime desc", DateTime.Now );
        ...
        public void Update()
        {
            ...
            using( ISession session = SessionFactory.CreateDefaultSession() )
            {
                ...
                Assert.AreEqual( 0, person.IsActive );
                ...
                Assert.AreEqual( 1, person.IsActive );
            }
        }
